...
const resizeImagesVehicle = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const resizeImagesBanner = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const resizeImagesTestimoni = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export { resizeImagesVehicle, resizeImagesBanner, resizeImagesTestimoni };
