...
const updateMulterUploadMiddlewareVehicle = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const updateMulterUploadMiddlewareBanner = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const updateMulterUploadMiddlewareTestimoni = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export {
  updateMulterUploadMiddlewareVehicle,
  updateMulterUploadMiddlewareTestimoni,
  updateMulterUploadMiddlewareBanner,
};
